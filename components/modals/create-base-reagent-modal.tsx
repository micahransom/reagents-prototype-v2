...
import { createItem, updateItem, deleteItem } from "@/lib/mock-db/db-helpers";
import { Item } from "@/lib/types";

interface CreateBaseReagentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
...
export default function CreateBaseReagentModal({
  isOpen,
  onClose,
  onSuccess,
  onOpenBulkUpload,
  editItem,
}: CreateBaseReagentModalProps) {
          ...
          <div className="flex items-start justify-between p-6 pb-4">
            <div className="flex flex-col gap-1.5">
              <h2 className="text-lg font-semibold text-slate-950">
                {editItem ? 'Edit Base Reagent' : 'New Base Reagent'}
              </h2>
              {!editItem && (
                <button
                  type="button"
